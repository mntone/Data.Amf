...
namespace Mntone { namespace Data { namespace Amf {
	...
	extern void ConvertFromBigEndian( const void *const from, void *const to, const size_t size );
	extern void ConvertFromLittleEndian( const void *const from, void *const to, const size_t size );

	extern void ConvertToBigEndian( const void *const from, void *const to, const size_t size );
	extern void ConvertToLittleEndian( const void *const from, void *const to, const size_t size );
