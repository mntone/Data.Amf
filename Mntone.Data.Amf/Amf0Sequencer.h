...
namespace Mntone { namespace Data { namespace Amf {
	...
	private:
		...
		void SequencifyObjectBase( AmfObject^ input, std::basic_stringstream<uint8>& stream );

		void SequencifyStrictArray( IAmfValue^ input, std::basic_stringstream<uint8>& stream );

		void SequencifyUtf8( const std::string& input, std::basic_stringstream<uint8>& stream );
		void SequencifyUtf8( Platform::String^ input, std::basic_stringstream<uint8>& stream );
		void SequencifyUtf8( IAmfValue^ input, std::basic_stringstream<uint8>& stream );
		void SequencifyUtf8Long( const std::string& input, std::basic_stringstream<uint8>& stream );
		void SequencifyUtf8Long( Platform::String^ input, std::basic_stringstream<uint8>& stream );
		void SequencifyUtf8Long( IAmfValue^ input, std::basic_stringstream<uint8>& stream );

		int32 IsReference( IAmfValue^ input );
		void SequencifyReference( int32 input, std::basic_stringstream<uint8>& stream );
