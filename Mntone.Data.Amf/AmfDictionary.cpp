...
bool AmfDictionary::GetBoolean( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }
float64 AmfDictionary::GetNumber( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }
Platform::String^ AmfDictionary::GetString( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }
Windows::Foundation::DateTime AmfDictionary::GetDate( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }
Platform::Array<uint8>^ AmfDictionary::GetByteArray( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }
Windows::Foundation::Collections::IVector<int32>^ AmfDictionary::GetVectorInt( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }
Windows::Foundation::Collections::IVector<uint32>^ AmfDictionary::GetVectorUint( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }
Windows::Foundation::Collections::IVector<float64>^ AmfDictionary::GetVectorDouble( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }
Windows::Foundation::Collections::IVector<IAmfValue^>^ AmfDictionary::GetVectorObject( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }
AmfObject^ AmfDictionary::GetObject( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }
AmfArray^ AmfDictionary::GetArray( void ) { throw com_exception_helper::create_invalid_operation_exception( "Invalid value type." ); }

AmfDictionary^ AmfDictionary::GetDictionary( void )
{
...
Windows::Foundation::Collections::IIterator<IAmfPair^>^ AmfDictionary::First( void ) { return vector_->First(); }

IAmfPair^ AmfDictionary::GetAt( uint32 index ) { return vector_->GetAt( index ); }
Windows::Foundation::Collections::IVectorView<IAmfPair^>^ AmfDictionary::GetView( void ) { return vector_->GetView(); }
...
void AmfDictionary::RemoveAtEnd( void ) { vector_->RemoveAtEnd(); }
void AmfDictionary::Clear( void ) { vector_->Clear(); }
...
#if !_WINDOWS_PHONE
Platform::String^ AmfDictionary::ToString( void )
{
