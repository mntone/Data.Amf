...
public:
	...
	{
		TestAmf0( ref new TestByteArray{ 15, 0, 0, 0, 6, 0x3c, 0x72, 0x6f, 0x6f, 0x74, 0x3e }, []( IAmfValue^ amfValue )
		{
...
private:
	...
	void TestAmf0( TestByteArray^ rawData, std::function<void( IAmfValue^ )> checkHandler )
	{
